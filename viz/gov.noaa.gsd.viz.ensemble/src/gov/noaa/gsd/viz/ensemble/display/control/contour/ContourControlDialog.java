 ...
 * ------------ ---------- ----------- --------------------------
 * Feb 28, 2017   DCS19598  jing     Initial creation
 *
 * </pre>
 *
 * @author jing
...
public class ContourControlDialog extends CaveJFACEDialog {
    ...
    private void createContourArea() {
        ...
        contourIncreaseButton.setSize(sideLength, sideLength);
        contourIncreaseButton.setToolTipText("Increase contour value");
        ...
        contourDecreaseButton.setSize(sideLength, sideLength);
        contourDecreaseButton.setToolTipText("Decrease contour value");
    ...
    /**
     * Does increasing or decreasing the specified contour.
     * 
     * @param increase
    ...
    protected void enableDefaultContourWidgetState() {
        ...
        mainPanelComposite.getShell().setMinimumSize(mainPanelComposite.getShell().getSize());
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        updateButton.setToolTipText("Update the contour display");
